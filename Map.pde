...
PVectorInt spawners[] = new PVectorInt[nSpawner];
...
private class MapClass {
    ...
    public void generatePath(PVectorInt startPos) {
        Node start = new Node(new PVector(startPos.x, startPos.y));
        Node end = new Node(endPos);
        createNode(new PVector(startPos.x, startPos.y), new PVector(-1, 0));
